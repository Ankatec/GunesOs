...
const Minesweeper: React.FC = () => {
  ...
  const reveal = useCallback(
    (board: CellState[][], r: number, c: number) => {
  ...
  return (
    <div className="w-full h-full bg-[#c0c0c0] flex flex-col items-center p-3 overflow-auto">
      ...
      <div className="flex items-center gap-4 mb-3 bg-[#c0c0c0] border-2 border-t-[#808080] border-l-[#808080] border-b-white border-r-white p-2">
        ...
        <button
          onClick={reset}
          className="w-8 h-8 bg-[#c0c0c0] border-2 border-t-white border-l-white border-b-[#808080] border-r-[#808080] flex items-center justify-center text-lg active:border-t-[#808080] active:border-l-[#808080] active:border-b-white active:border-r-white"
        >
          {gameOver ? "😵" : won ? "😎" : "🙂"}
        </button>
        <div className="bg-black text-red-500 font-mono text-xl font-bold px-2 py-1 min-w-[50px] text-center">
          ...
          <div key={r} className="flex">
            {row.map((cell, c) => (
              <button
                ...
                style={{
                  color: cell.isRevealed && !cell.isMine ? numberColors[cell.adjacentMines] || "black" : undefined,
                }}
