...
const BootScreen: React.FC<BootScreenProps> = ({ onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 bg-[#000080] flex flex-col items-center justify-center z-[9999] select-none">
      ...
      >
        <img
          src="https://mgx-backend-cdn.metadl.com/generate/images/1158115/2026-04-27/nnvmxjyaafmq/gunesOS-logo-sun.png"
          alt="GüneşOS"
      ...
      {phase !== "logo" && (
        <div className="w-64 flex flex-col items-center gap-3">
          <div className="w-full h-5 bg-[#000040] border-2 border-inset border-t-[#404080] border-l-[#404080] border-b-[#8080c0] border-r-[#8080c0] p-[2px]">
            <div
